...
export default function PartnerCarousel() {
  ...
  // Faixa contínua duplicada para permitir um ciclo sem interrupções
          ...
          {doubled.map((item, idx) => (
            ...
            >
              ...
              <img
                src={item.logo}
                alt={item.name}
                className="max-h-14 max-w-full object-contain transition-transform duration-300 transform group-hover:scale-105"
              />
